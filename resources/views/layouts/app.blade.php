    ...
    <div class="h-full flex" x-data="{ sidebarOpen: false }">
        ...
        <nav :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}" class="fixed inset-y-0 left-0 z-50 w-64 bg-blue-700 text-white transition-transform duration-300 lg:translate-x-0 lg:static lg:flex-shrink-0 flex flex-col shadow-xl">
            ...
            <div class="p-4 flex-1 overflow-y-auto space-y-2">
                ...
                <a href="/staff/master/polyclinics" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-blue-100 font-medium hover:bg-blue-600/50 hover:text-white transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="/staff/master/import" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-blue-100 font-medium hover:bg-blue-600/50 hover:text-white transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="/staff/master/export" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-blue-100 font-medium hover:bg-blue-600/50 hover:text-white transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
